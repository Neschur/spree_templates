...
require 'spree_templates/version'

Gem::Specification.new do |s|
  s.platform    = Gem::Platform::RUBY
  s.name        = 'spree_templates'
  s.version     = SpreeTemplates.version
  s.summary     = 'Extention to manage the views from admin'
  s.description = s.summary
  s.required_ruby_version = '>= 2.1.0'

  s.authors      = ['Peter Berkenbosch', 'Roman Smirnov']
  s.email        = 'peter@pero-ict.nl'
  s.homepage     = 'https://github.com/Neschur/spree_templates'
  s.license      = 'BSD-3'
